...
ActiveRecord::Schema[8.0].define(version: 2025_02_16_080917) do
  ...
  create_table "certificate_subgroups", force: :cascade do |t|
    t.bigint "certificate_id"
    t.bigint "subgroup_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["certificate_id"], name: "index_certificate_subgroups_on_certificate_id"
    t.index ["subgroup_id"], name: "index_certificate_subgroups_on_subgroup_id"
  end
  ...
  add_foreign_key "certificate_subgroups", "certificates"
